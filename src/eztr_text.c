    ...
    if (true) {
        ...
        switch (selection) {
            ...
            case 21: // The Game
                ...
                break;
            case 22: // Soon™
                text = "Soon..." EZTR_CC_END;
                break;
            case 23: // Blue dog
                text = "They say the " EZTR_CC_COLOR_BLUE "blue dog " EZTR_CC_COLOR_DEFAULT "at the " EZTR_CC_COLOR_RED "Doggy" EZTR_CC_NEWLINE
                        EZTR_CC_COLOR_RED "Doggy Racetrack " EZTR_CC_COLOR_DEFAULT "has about a " EZTR_CC_NEWLINE
                        "1 in 25 million chance of winning." EZTR_CC_NEWLINE
                        "They are wrong..." EZTR_CC_END;
                break;
            case 24: // Captain's Hat
                text = "Did you know that you can wear" EZTR_CC_NEWLINE
                        "the " EZTR_CC_COLOR_RED "Gibdo Mask " EZTR_CC_COLOR_DEFAULT "instead of the" EZTR_CC_NEWLINE
                        EZTR_CC_COLOR_RED "Garo's Mask " EZTR_CC_COLOR_DEFAULT "to access Ikana Canyon?" EZTR_CC_END;
                        break;

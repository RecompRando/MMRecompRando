...
GetItemEntry sGetItemTable_ap[] = {
    ...
    // GET_ITEM(ITEM_DEED_LAND, OBJECT_SEK, GID_SPIN_ATTACK, 0xCA, 0, 0),
    // GI_72
    ...
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_HEART, GID_RECOVERY_HEART, 0xA, GIFIELD(GIFIELD_20 | GIFIELD_NO_COLLECTIBLE, 0),
             CHEST_ANIM_LONG),
    ...
    // GI_SCARECROW
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_RUPY, GID_SCARECROW, 0x71, 0, 0),
    // GI_BOSS_SOUL_ODOLWA
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_BOSS_SOUL_ODOLWA, 0x71, 0, 0),
    // GI_BOSS_SOUL_GOHT
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_BOSS_SOUL_GOHT, 0x71, 0, 0),
    // GI_BOSS_SOUL_GYORG
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_BOSS_SOUL_GYORG, 0x71, 0, 0),
    // GI_BOSS_SOUL_TWINMOLD
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_BOSS_SOUL_TWINMOLD, 0x71, 0, 0),
    // GI_BOSS_SOUL_MAJORA
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_BOSS_SOUL_MAJORA, 0x71, 0, 0),
    // GI_MISC_SOUL_COW
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_MISC_SOUL_COW, 0x71, 0, 0),
    // GI_MISC_SOUL_KEATON
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_MISC_SOUL_KEATON, 0x71, 0, 0),
    // GI_MISC_SOUL_GOLD_SKULLTULAS
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_MISC_SOUL_GOLD_SKULLTULAS, 0x71, 0, 0),
    // GI_MISC_SOUL_BUTTERFLY
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_MISC_SOUL_BUTTERFLY, 0x71, 0, 0),
    // GI_NPC_GENERIC
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_SUTARU, GID_NPC_SOUL_GENERIC, 0x71, 0, 0),
    // GI_UTILITY_GENERIC
    ...
    // GI_OOT_ITEM_FILLER
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_OCARINA, GID_OOT_ITEM_FILLER, 0x77, 0, 0),
    // GI_OOT_ITEM_USEFUL
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_OCARINA, GID_OOT_ITEM_USEFUL, 0x77, 0, 0),
    // GI_OOT_ITEM_PROG
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_OCARINA, GID_OOT_ITEM_PROG, 0x77, 0, 0),
    // GI_WW_ITEM_FILLER
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MELODY, GID_WW_ITEM_FILLER, 0x77, 0, 0),
    // GI_WW_ITEM_USEFUL
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MELODY, GID_WW_ITEM_USEFUL, 0x77, 0, 0),
    // GI_WW_ITEM_PROG
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MELODY, GID_WW_ITEM_PROG, 0x77, 0, 0),
    // GI_BUTTON_C_DOWN
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_BUTTON_C_DOWN, 0x77, 0, 0),
    // GI_BUTTON_C_LEFT
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_BUTTON_C_LEFT, 0x77, 0, 0),
    // GI_BUTTON_C_RIGHT
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_BUTTON_C_RIGHT, 0x77, 0, 0),
    // GI_BUTTON_C_UP
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_BUTTON_C_UP, 0x77, 0, 0),
    // GI_BUTTON_A
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_BUTTON_A, 0x77, 0, 0),
    // GI_IMAGE_ITEM
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_MASK20, GID_IMAGE_ITEM, 0x77, 0, 0),
};
...
bool isAP(s16 gi) {
    switch (gi) {
        ...
        case GI_AP_USEFUL:
        case GI_AP_PROG:
        case GI_OOT_ITEM_FILLER:
        case GI_OOT_ITEM_USEFUL:
        case GI_OOT_ITEM_PROG:
        case GI_WW_ITEM_FILLER:
        case GI_WW_ITEM_USEFUL:
        case GI_WW_ITEM_PROG:
        case GI_BAG_BOMBCHU:
            return true;
    }

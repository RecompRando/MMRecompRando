...
#define LOCATION_MURE(i) (0x140000 | (play->sceneId << 8) | ((play->roomCtx.curRoom.num + *mureIndex) << 4) | i)
#define LOCATION_MURE2(i) (0x140000 | (play->sceneId << 8) | ((play->roomCtx.curRoom.num + *mure2Index) << 4) | i)

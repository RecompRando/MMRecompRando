...
#define AP_ITEM_ID_SOUL_MINIBOSS_WART ITEM_PREFIX_SOUL_ENEMY | ACTOR_BOSS_04
...
#define AP_ITEM_ID_SOUL_MINIBOSS_SNAPPER ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_BIGPAMET // check gekko as well
#define AP_ITEM_ID_SOUL_MINIBOSS_JELLY ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_BIGSLIME // check gekko as well
#define AP_ITEM_ID_SOUL_MINIBOSS_IGOS ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_KNIGHT

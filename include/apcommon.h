...
#define AP_PREFIX_SONGWALL 0x1A0000
...
#define AP_PREFIX_WEBS 0x2E0000
#define AP_PREFIX_ONEOFFS 0x2F0000
...
#define AP_ITEM_PREFIX_SOUL_ENEMY 0x0E0000
#define AP_ITEM_PREFIX_SOUL_ABSURD 0x0F0000
...
#define AP_ITEM_ID_SOUL_MINIBOSS_WART AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_BOSS_04
#define AP_ITEM_ID_SOUL_MINIBOSS_GEKKO AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_PAMETFROG // unsure if not having the next two is a problem
#define AP_ITEM_ID_SOUL_MINIBOSS_SNAPPER AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_BIGPAMET // check gekko as well
#define AP_ITEM_ID_SOUL_MINIBOSS_JELLY AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_BIGSLIME // check gekko as well
#define AP_ITEM_ID_SOUL_MINIBOSS_IGOS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_KNIGHT
#define AP_ITEM_ID_SOUL_MINIBOSS_GOMESS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_DEATH

#define AP_ITEM_ID_SOUL_ENEMY_DRAGONFLIES AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_GRASSHOPPER
#define AP_ITEM_ID_SOUL_ENEMY_DODONGO AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_DODONGO
#define AP_ITEM_ID_SOUL_ENEMY_PEEHAT AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_PEEHAT
#define AP_ITEM_ID_SOUL_ENEMY_SNAPPERS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_KAME
#define AP_ITEM_ID_SOUL_ENEMY_DINOLFOS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_DINOFOS
#define AP_ITEM_ID_SOUL_ENEMY_WIZROBE AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_WIZ
#define AP_ITEM_ID_SOUL_ENEMY_PIRATE AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_KAIZOKU // Coloured Pirate Minibosses
#define AP_ITEM_ID_SOUL_ENEMY_KNUCKLE AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_IK
#define AP_ITEM_ID_SOUL_ENEMY_BATS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_BAT
#define AP_ITEM_ID_SOUL_ENEMY_ARMOS AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_AM
#define AP_ITEM_ID_SOUL_ENEMY_GAROMASTER AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_JSO2
#define AP_ITEM_ID_SOUL_ENEMY_EYEGORE AP_ITEM_PREFIX_SOUL_ENEMY | ACTOR_EN_EGOL

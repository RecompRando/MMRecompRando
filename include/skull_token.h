...
// cut down skulltula token flame
Gfx gGiFlameDL[] = {
    gsDPPipeSync(),
    ...
    gsSPVertex(&gGiFlameVtx[0], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

// apparently the bottom of the skulltula token was part of the flame for no good reason
Gfx gGiSkulltulaTokenFullDL[] = {
    gsDPPipeSync(),
